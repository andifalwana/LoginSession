...
class LoginRepository extends Repository {
  Future logout() async {
    ...
    final response = await _dio.post('https://andifalwana.000webhostapp.com/logout.php', data: fdata,);
  ...
  Future login({required String username, required String password}) async {
    ...
    final response = await _dio.post('https://andifalwana.000webhostapp.com/login.php', data: fdata);
    log("res $response");
